                ...
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <a href="" class="font-weight-bold btn btn-danger">Trash Contact-Counter <i class="fa fa-arrow-right"></i></a>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table mb-0 text-center data-table-said table-bordered table-secondary">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($contact_counter as $item)
                                            <tr>
                                                <td>{{ $loop -> index + 1 }}</td>
                                                <td>{{ $item -> title }}</td>
                                                <td>{{ $item -> counter }}</td>
                                                <td style="font-size: 20px"> <i class="{{ $item -> icon }}"  style="background-color: blue;color:white;padding:10px;border-radius:20%"></i> </td>
                                                ...
                                                <td>
                                                    <a href="{{route('counter-contact.edit', $item -> id)}}" class="btn btn-sm btn-warning"><i class="fa fa-edit" ></i></a>
                                                    <form action="{{route('counter-contact.destroy', $item -> id)}}" method="POST" class="d-inline">
                                                      @csrf
                                                      @method('DELETE')
                ...
                <div class="col-md-4">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Add new Contact-Counter</h4>
                        </div>
                        <div class="card-body">
                            @include('validate')
                            <form action="{{route('counter-contact.store')}}" method="POST">
                                @csrf
                                ...
                                <div class="form-group">
                                    <label>Counter</label>
                                    <input name="counter" type="text" value="{{old('counter')}}" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>Icon</label><br>
                                    <button class="btn btn-sm btn-danger my-2" id="show-icon">Select Icon</button>
                                    <input name="icon" type="text" value="{{old('icon')}}" class="form-control select-icon-input">
                                </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Edit Contact-Counter</h4>
                        </div>
                        <div class="card-body">
                            @include('validate')
                            <form action="{{route('counter-contact.update', $edit -> id)}}" method="POST">
                              @csrf
                              @method('PUT')
                              <div class="form-group">
                                  <label>Title</label>
                              ...
                              <div class="form-group">
                                  <label>Counter</label>
                                  <input name="counter" type="text" value="{{ $edit -> counter }}" class="form-control">
                              </div>
                              <div class="form-group">
                                  <label>Icon</label><br>
                                  <button class="btn btn-sm btn-danger my-2" id="show-icon">Select Icon</button>
                                  <input name="icon" type="text" value="{{ $edit -> icon }}" class="form-control select-icon-input">
                              </div>
                              <div class="text-right">
                                  <a class="btn btn-primary shadow" href="{{route('counter-contact.index')}}">Back</a>
                                  <button type="submit" class="btn btn-warning shadow">Submit</button>
                              </div>
                          </form>
                        </div>
...
<!-- /Main Wrapper -->
  ...
  {{-- Model Start --}}
  <div id="icon-select" class="modal fade">
    <div class="modal-dialog modal-lg shadow-lg">
        <div class="modal-content">
            <div class="modal-body" style="background-color: #052842;">

                <style>
                    .icon-select-said .preview-icon{
                        font-size: 25px;
                        font-weight: bold;
                ...
                <div class="row bordered icon-select-said">
