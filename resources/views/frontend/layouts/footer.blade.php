          ...
          <div class="col-md-12">
            <div class="widget">
              ...
              <div class="footer-newsletter">
                @include('validate')
                <form action="{{route('subscribe.store')}}" method="POST"  class="inline-form">
                  @csrf
                  <div class="input-group">
                    <input type="email" name="email" placeholder="Your Email" class="form-control"><span class="input-group-btn"><button type="submit"  class="btn btn-color">Subscribe</button></span>
                  </div>
                </form>
              </div>
              @php
              ...
              <div class="mb-3 d-flex" style="margin-top: -5px">
                {{-- @foreach ($subscribe as $item) --}}
                    <marquee scrollamount="1" behavior="alternate" direction="" style="border: 1px solid #333;margin-top:7px"> <p class="text-danger"> <h5 class="d-flex text-danger" style="font-weight:bold;"><i class="ti-user"></i> Subscribe Member   {{count($subscribe)}}K</h5>  </p> </marquee>
                {{-- @endforeach    --}}
  ...
  <div class="container">
    <div class="footer-wrap">
      <div class="row">
        <div class="col-md-4">
          <div class="copy-text">
            <p><i class="icon-heart red mr-15"></i>© 2022 Sharif.</p>
          </div>
        </div>
        <div class="col-md-4">
